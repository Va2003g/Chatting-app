          ...
          <View className="gap-4">
            ...
            <View>
              {loading ? (
                ...
                <TouchableOpacity onPress={handleRegister} className="bg-indigo-500 rounded-xl justify-center" style={{ height: hp(6.5) }}>
                  <Text style={{ fontSize: hp(2.7) }} className="text-white font-bold tracking-wider text-center">
                    Sign Up
                  </Text>
                </TouchableOpacity>
              )}
